  ...
  <section id='pricing'>
    ...
    <Wrapper>
      <div className='mt-32'>
        ...
        <div className=' flex flex-col  border-2 bg-blue-50  h-[40rem]  items-center rounded-md' >
          ...
          <div className='grid grid-cols-3 mt-10 gap-11'>
            {
              data.map((elm, id) => (
                ...
                <div className='flex flex-col  w-[18rem] h-[25rem] bg-white  items-center  shadow-xl rounded-md' key={elm.id}>
